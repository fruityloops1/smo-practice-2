...
public:
    ...
    void getPortNo() override;
    IUsePlayerCollision* getPlayerCollision() override;
    PlayerHackKeeper* getPlayerHackKeeper() const override;
    void isEnableDemo() override;
    ...
    void isDamageStopDemo() override;
    void getPlayerPuppet() override;
    void getPlayerInfo() override;
